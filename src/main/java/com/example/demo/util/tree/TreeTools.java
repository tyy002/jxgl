...
public class TreeTools {
	...
	@SuppressWarnings("unchecked")
	public static List<Map<String, Object>> turnListToTree2(List<Map<String, Object>> menuList, boolean isChecked) {
		// TODO 转换List为树形结构
		menuList = handleTree(menuList, isChecked);
