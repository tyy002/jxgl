...
public class ChkTools {
	...
	/**
	 * 
	 * @Description: 根据(方法中,访问地址中)的参数类型返回相应的数据类型 @param reqParamValue @param
	 * paramType @return @throws
	 */
	...
	/**
	 * 
	 * @Description:判断是否为基本数据类型 @param paramType @return @throws
	 */
	public static boolean isBasicType(Class<?> paramType) {
		Class<?>[] basic = { Boolean.class, Character.class, Byte.class, Short.class, Integer.class, Long.class,
	...
	/**
	 * 
	 * @Description:判断时间格式00:00:00 @param time @return @throws
	 */
	...
	/**
	 * 
	 * @Description:判断map是否为空 @param Map <String, Object > map @return @throws
	 */
